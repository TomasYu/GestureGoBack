...
import com.xinyu.gesturegoback.R;
...
public class GuestureLayout extends FrameLayout {
     ...
     * 默认的边缘宽度
     */
    private static  int DEFAULT_EDGE_SIZE		;
    ...
    private void init(Context context){
        DEFAULT_EDGE_SIZE= Util.dipToPixel2(context, 5);
        ...
        mShadowScrim = getResources().getDrawable(R.drawable.main_right_frontground);
        //设置边缘的阴影
